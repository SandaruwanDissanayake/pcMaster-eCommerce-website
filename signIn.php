        ...
        <div class="row">
            ...
            <div class="col-12 mt-5" style="display: flex; align-items: center; justify-content: center;">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12  mt-5 m-5 rounded-3 col-lg-7 sign-inBox" data-aos="zoom-in">
                        <div class="row">
                            <div class="col-12">
                                <div class="row justify-content-center">
                                    <div class="col-11  mt-3 mb-3">
                                        <h3 class="text-center fw-bold text-white mt-5" data-aos="zoom-in" data-aos-delay="200">Sign In</h3>
                                        <hr>
                                        <div class="row">
                                            <!-- SignIn -->
                                            ...
                                            <div class="col-12" id="signInBox">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <div class="col-6" data-aos="zoom-in" data-aos-delay="800">
                                                        <div class="row m-3">
