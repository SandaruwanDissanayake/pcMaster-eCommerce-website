        ...
        <div class="col-12">
                                            ...
                                            <div class="col-11 m-3 border-bottom border-dark border-top p-2">
                                                <div class="row">
                                                    ...
                                                    <div class="col-5 border-end border-dark">
                                                        ...
                                                        <input type="number" value="1" min="1" onclick="cart_qty_update(<?php echo $p_data['id']; ?>);" onkeyup="cart_qty_update(<?php echo $p_data['id']; ?>);" id="qty_input">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row">
                                                        ...
                                                        $cart_sum_rs = Database::search("SELECT SUM(product.price) AS tp FROM `product` 
            ...
            ?>
                <div class="row justify-content-center">
                    <div class="col-11 shadow-lg">
                        <div class="row justify-content-center">
                            <h5 class="text-center mt-5 mb-5" data-aos="zoom-in">Pleace Log In Frist</h5>
                            <button class="btn btn-success col-5 mt-5 mb-5" data-aos="zoom-in">Log In Or Sign Up</button>
                        </div>
