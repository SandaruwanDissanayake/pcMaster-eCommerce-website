...
<body style="overflow-x: hidden; width: 100%;" onload="changestatesCart();">
  ...
  <section id="search">
    ...
    <div class="col-12 z-in" style="margin-top: 130px;">
      <div class="row justify-content-center">
        <div class="col-11 shadow-lg" style=" height: 50px;">
          <div class="row mt-1">
            ...
            <div class="col-lg-2 col-6" style="cursor: pointer;" onclick="advansSerch();">
  ...
  <section id="basicSearchResult">
    ...
    <section>
      ...
      <div class="col-12 mt-4 z-in" style="width: 100%; ">
        <div class="row">
          ...
          <div class="col-12 shadow-lg">
            <div class="row justify-content-center">
              ...
              ?>
                ...
                <div onclick="catogorybox('<?php echo $catogory_data['id']; ?>')" class="col-lg-2 col-5 mt-4 mb-4 mx-1 z-in" style="background-color: red; height: 200px; cursor: pointer;" data-aos="zoom-in">
    ...
    <section>
      <div class="col-12 mt-5" style="margin-top: -60px;">
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="row">
        ...
        <div class="col-12 shadow-lg">
          <div class="row justify-content-center">
            ...
            ?>
              ...
              <div class="col-lg-3 mx-1 mt-4 col-11 shadow p-3 mb-5 bg-body rounded z-in" href='<?php echo "singleProduct.php?id=" . $product_data["id"] ?>'>
                  ...
                  <div class="col-11 bg-white" style="width: 100%; height: 100px; ">
                    <div class="row">
                      ...
                      <div class="col-2 mt-3" style="flex-direction: column;">
                        ...
                        if (isset($_SESSION["u"])) {
                          $wl_rs=Database::search("SELECT * FROM `watchlist` WHERE `user_email_email`='".$user["email"]."' AND `product_id`='".$product_data["id"]."'");
                          $wl_num=$wl_rs->num_rows;

                          if($wl_num==0){
                            ?>
                          <h5 class="col-12 text-center text-success" style="cursor: pointer;" onclick="addwatchlist('<?php echo $product_data['id']; ?>');"><i class="bi bi-heart"></i></h5>
                            
                            <?php
                          }else{
                            ?>
                          <h5 class="col-12 text-center text-danger" style="cursor: pointer;" onclick="addwatchlist('<?php echo $product_data['id']; ?>');"><i class="bi bi-heart"></i></h5>
                        ...
                        ?>
                          <h5 class="col-12 text-center" style="cursor: pointer;" onclick="addwatchlist('<?php echo $product_data['id']; ?>');"><i class="bi bi-heart"></i></h5>
