        ...
        <div class="row">
            ...
            <div class="col-12 " style="display: flex; align-items: center; justify-content: center; height: 700px;">
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 sign-inBox  rounded-3 col-lg-7 " data-aos="zoom-in">
                        <div class="row">
                            <div class="col-12">
                                <div class="row justify-content-center">
                                    <div class="col-11 rounded-3  ">
                                        <h3 class="text-center mt-5 fw-bold text-white" data-aos="zoom-in" data-aos-delay="200">Register Now</h3>
                                        <hr>
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6" data-aos="zoom-in" data-aos-delay="1000">
                                                        <div class="row">
                                                            <div class="form-floating mb-3">
