...
<body style="overflow-x: hidden;">
  ...
  <section id="basicSearchResult">
        ...
        <div class="row justify-content-center">
          <div class="col-11">
            <div class="row">
              ...
              <div class=" mx-lg-5 col-12 col-lg-6 " data-aos="fade-left">
                <div class="row justify-content-center mx-2">
                  <div class="col-11 border-bottom ">
                    ...
                    <div class="row border-bottom border-dark">
                      ...
                      <div class="col-2 mt-3 mb-3 ">
                        <div class="row">
                          <input type="number" value="1" min="1" id="qty_input">
                        </div>
                      </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="row mt-3 justify-content-center">
                        ...
                        <div class="col-lg-3 col-12  m-2">
                          <div class="row justify-content-center">
                            <button class="btn btn-success rounded-4 " style="font-size: 13px;">Add To Cart </button>
    ...
    <section style="margin-top: -50px;" data-aos="zoom-in">
      <div class="col-12 ">
        <div class="row m-5">
          <div class="col-5">
