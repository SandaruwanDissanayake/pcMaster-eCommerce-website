...
if (isset($_SESSION["u"])) {
    ...
    if (isset($_FILES["image"])) {
        ...
        if (!in_array($file_ex, $allowed_image_extentions)) {
            ...
            $file_name = "resouses/user_data/" . $_SESSION["u"]["fname"] . "_" . uniqid() . $new_file_extention;
    ...
    if ($address_num == 1) {
        Database::iud("UPDATE `user_has_address` SET `address_line_1`='" . $line1 . "',
        ...
        (`address_line_1`,`address_line_2`,`user_email`,`city_id`,`postal_code`) VALUES
